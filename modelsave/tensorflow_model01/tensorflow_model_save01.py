...
# 모델 저장 - HDF5 형실의 파일로 저장
model.save('D:/PythonML_Practical/modelsave/tensorflow_model01/fashionmnist_cnn01.h5')
print('모델 저장 완료: {}'.format('D:/PythonML_Practical/modelsave/tensorflow_model01/fashionmnist_cnn01.h5'))